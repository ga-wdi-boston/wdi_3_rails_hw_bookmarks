...
Comment.create(body: "tired of facebook...", bookmark: @bookmark1)
Comment.create(body: "I spend too much time on facebook", bookmark: @bookmark1)
Comment.create(body: "BBC is much better", bookmark: @bookmark2)
